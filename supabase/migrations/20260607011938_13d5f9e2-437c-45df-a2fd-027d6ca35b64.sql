CREATE OR REPLACE FUNCTION public.get_painel_tv_data(_school_id uuid, _weekday_override smallint DEFAULT NULL)
 RETURNS jsonb
 LANGUAGE plpgsql
...
GRANT EXECUTE ON FUNCTION public.get_painel_tv_data(uuid, smallint) TO anon, authenticated;